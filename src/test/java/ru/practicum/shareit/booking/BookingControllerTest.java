...
class BookingControllerTest {
    ...
    void addBooking() {
        ...
        verify(service, times(1)).addBooking(any(Booking.class), anyLong());
    ...
    void updateBooking() {
        ...
        assertEquals(actual, booking);
        verify(service, times(1)).updateBooking(anyLong(), anyLong(), anyBoolean());
        verifyNoMoreInteractions(service);
    }
    ...
    void deleteBooking() {
        ...
        verify(service, times(1)).deleteBooking(anyLong(), anyLong());
        verifyNoMoreInteractions(service);
    }
    ...
    void getAllBookingsByUserId() {
        ...
        verify(service, times(1))
                .getAllBookingsByBookerIdAndState(anyLong(), anyString(), anyInt(), anyInt());
        verifyNoMoreInteractions(service);
    }
    ...
    void getAllBookingsByState() {
        ...
        assertEquals(0, actual.size());
        verify(service, times(1))
                .getAllBookingsByOwnerIdAndState(anyLong(), anyString(), anyInt(), anyInt());
        verifyNoMoreInteractions(service);
    }
}
